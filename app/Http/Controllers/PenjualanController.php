...
// SUDAH DIPERBAIKI: Mengubah koper kapital APP menjadi App
use App\Http\Requests\SearchRequest; 
use App\Models\Penjualan; 
use App\Models\Produk; // Diubah P kapital sesuai nama file model Anda
...
{ 
    ...
    { 
         request()->user()->can('delete', $penjualan);
        ...
        // Pastikan masih user login (kasir) 
